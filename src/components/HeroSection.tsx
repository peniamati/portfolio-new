    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            {t.hero.firstName}{" "}
            <span className="text-gradient">{t.hero.lastName}</span>
          </motion.h1>
          ...
          >
            {t.hero.role}{" "}
            <span className="text-foreground font-medium">{t.hero.company}</span>
            <span className="text-muted-foreground font-light"> · {t.hero.companyGroup}</span>
          </motion.h2>
