...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-24 lg:py-32 bg-card/50" aria-label={t.contact.title}>
      <div className="container mx-auto px-6">
        ...
        >
          <p className="font-mono text-sm text-primary mb-2">{t.contact.tag}</p>
